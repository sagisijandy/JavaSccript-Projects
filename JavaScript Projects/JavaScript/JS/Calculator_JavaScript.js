...
const Calculator = {
    ...
    Display_Value: '0',
    // this will hold the first operand for expressions, we set it to null for now
    First_Operand: null,
...
function Input_Decimal(dot) {
    ...
    // doesn't cause bugs in your opertion
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        //if operstor exists, property lookup is performed for the operstor
        //in the Perform_Calculation object and the function taht matches the
        //opersator is executed
        let result = Perform_Calculation[operator] (Value_Now, Value_of_Input);
        //here we add a fixed amount of nnumbers after the decimal
