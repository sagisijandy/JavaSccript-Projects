...
function placeXOrO(sqaureNumber) {
    ...
    //This variable retrieves the html element id that was clicked.
        ...
        if(activePlayer === "O") {
            //This function disables clicking for computer to choice.
            disableClick();
...
//This finction parses the selectedSquares array to search for win conditions.
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        //The next # variables will be used to check for 3 in a row.
...
//This function takes a string parameters of the path you set earlier for
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line indicates where the start of a lines x axix is.
    let x1 = coordX1,
...
function animateLineDrawing() {
    ...
    c.lineWidth = 10;
    //This mehod sets the color of our line.
    ...
    //This was necessary for the 6, 4, 2 win condition.
    if (x1 <= x2 && y1 >= y2) {
        if (x < x2) { x += 10; }
        if (y > y2) { y -= 10; } 
        if (x >= x2 && y <= y2) { cancelAnimationFrame(animationLoop); }        
...
function clear() {
    ...
    c.clearRect(0, 0, 608, 608);
    //This line stops pur animation loop.
...
//This function resets thegame in a tie or a win.
function resetGame() {
